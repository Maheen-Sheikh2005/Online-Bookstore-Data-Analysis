...
-- Retrieve the total stock of books available in the store.
select sum(stock) as Total_stock
from Books;

-- Find details of the most expensive books .
select * from Books 
order by price desc
limit 1;
...
COALESCE(sum(o.quantity),0) as books_odered,
